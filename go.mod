...
// For local side-by-side development before the library is published,
// either use the go.work file shipped next to both repos, or uncomment:
// replace github.com/johnnycube/kasapi => ../kasapi
